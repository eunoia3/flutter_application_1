...
class MyStopPage extends StatefulWidget {
  @override
  _MyStopPageState createState() => _MyStopPageState();
}

class _MyStopPageState extends State<MyStopPage> with TickerProviderStateMixin{
            ...
            children: <Widget>[
              Column(
                ...
                children: <Widget>[
                  ...
                  NumberPicker(minValue: 0, maxValue: 23, value: hour, onChanged: (val){
                    setState(() {
                      hour = val;
                    });
                  }),
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  NumberPicker(minValue: 0, maxValue: 60, value: min, onChanged: (val){
                    setState(() {
                      min = val;
                    });
                  }),
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  NumberPicker(minValue: 0, maxValue: 60, value: sec, onChanged: (val){
                    setState(() {
                      sec = val;
                    });
                  }),
